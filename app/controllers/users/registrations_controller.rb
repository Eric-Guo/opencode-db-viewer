class Users::RegistrationsController < Devise::RegistrationsController
  ...
  def set_new_page_layout_data
    @_wrapper_class = %w[bg-body-tertiary min-vh-100 d-flex flex-row align-items-center]
    @_sidebar_name = nil
  end

  def set_edit_page_layout_data
    @_wrapper_class = %w[wrapper d-flex flex-column min-vh-100 bg-body-tertiary]
